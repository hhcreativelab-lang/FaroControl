...
# -----------------------------
OPERATIONS = {
    "Органайзер дно — заготовка — 4 ₽ + собачка 1 ₽": {
        "id": "OP001",
        "needs_dogs": True,
        "hint": "Укажите количество изделий и количество собачек. Расчёт: изделие 4 ₽ + собачка 1 ₽.",
    },
    ...
    "Кофр — заготовка — 18 ₽ + собачка 1 ₽": {
        "id": "OP006",
        "needs_dogs": True,
        "hint": "Укажите количество изделий и количество собачек. Расчёт: изделие 18 ₽ + собачка 1 ₽.",
    },
    "Кофр — окантовка — 24 ₽": {
        "id": "OP007",
        "needs_dogs": False,
